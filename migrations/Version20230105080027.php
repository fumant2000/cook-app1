 ...
 */
final class Version20230105080027 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tag ADD CONSTRAINT FK_389B7833D3D2749 FOREIGN KEY (children_id) REFERENCES tag (id) ON DELETE SET NULL');
    }
